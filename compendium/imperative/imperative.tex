...
% As an example of an action, consider eating lunch. Before the action takes
% place you're hungry, and after it you're sated. We call these the \key{pre-}
% and \key{postconditions}, respectively. To sate your hunger you usually have
% multiple options. For instance, you can \begin{inparaenum}[(1)] \item visit the
% student kitchen and make a sandwich, \item visit the commercial canteen and buy
% a sandwich, or \item visit the local food court and buy a wealthy
% meal\end{inparaenum}. The time it takes for every choice is somewhat the same,
% the difference, if anything is in the price, quality and choice of foods.
