...
architecture. Neither is particularly clever in practise. Any self-respecting
programmer knows that premature optimization is the root of all
...
evolve. Either due to bugs in the original implementation or due to changes in
the software requirements. What's more, software is usually evolved by people
other than the original programmers. To evolve software efficiently, the programmer has to be able to get 


We will come back to this thought after
we've covered some basics of computer architecture.
